...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        # print(model_kwargs['encoder_outputs'].last_hidden_state)
        return model_kwargs
    ...
    def greedy_search(
        ...
        **model_kwargs
        ...
        while cur_len < max_length:
            ...
            # print(outputs['past_key_values'][0])
            # abort()
            next_token_logits = outputs.logits[:, -1, :]
            if generate_logits:
                generate_logits.append(next_token_logits.unsqueeze(1))
            else:
                generate_logits = [next_token_logits.unsqueeze(1)]
        ...
        return input_ids, torch.cat(generate_logits, dim=1)
    ...
    def sample(
        ...
        **model_kwargs
        ...
        while cur_len < max_length:
            ...
            # print(scores.size())
            # abort()
            generate_logits.append(scores.unsqueeze(1))
